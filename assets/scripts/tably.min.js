...
// Tably - Version 1.2
(function($){$.extend({tably:function(options){var defaults={activeClass:'active',tabContainer:'#tabContainer',tabContentContaier:'#tabContentContainer',tabSelector:'.tab',contentSelector:'.tabContent',tabTransition:true,enableSaving:true};var cookieOptions={expires:365,path:'/'},cookieValue=$.cookie('tab_active'),options=$.extend(defaults,options),o=options;if(o.enableSaving===false){$.cookie('tab_active',null,cookieOptions);}
